document.addEventListener("DOMContentLoaded", () => {
  if (!window.serviceStatus) {
    console.error(
      "serviceStatus is not loaded. Check that js/status-data.js is loaded before js/status-render.js"
    );
    return;
  }
...
function getVisibleEngineeringWorks() {
  const serviceStatus = getStatusData();
